...
class Score():
    ...
    def updategame(self):
        self.text = ["BLUE", "GREEN", "ORANGE", "PINK", "RED", "YELLOW", "PURPLE", "BROWN", "GREY", "BLACK","Lightblue"]
        self.random_no_text = random.randint(0, 9)
        
        self.color = ["blue", "green", "orange", "pink", "red", "yellow", "purple", "brown", "grey", "black", "lightblue"]
        ...
        lbl_color.after(7000,self.updategame)
...
btn_check = Button(root, text = "CHECK", command = get_text_color, relief = FLAT, bg = "IndianRed1", fg = "white", padx = 10, pady = 1, font = ("Arial", 15))

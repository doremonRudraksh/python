...
btn = Button(root, text = "Apply MD5", command = apply_md5, bg = "black", fg = "white", relief = "flat")
btn.place(relx = 0.3, rely = 0.5, anchor = CENTER)

btn1 = Button(root, text = "Apply SHA256", command = apply_sha256, bg = "black", fg = "white", relief = "flat")
